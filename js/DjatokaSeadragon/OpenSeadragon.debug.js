...
Seadragon.Viewer.prototype = {
    ...
    openDzifromXMLString: function (xmlString) {
        var currentTime = this._beforeOpen();
    	Seadragon.DziTileSourceHelper.createFromXmlString(xmlString, Seadragon.Utils.createCallback(null, Function.createDelegate(this, this._onOpen), currentTime));
    },
...
Seadragon._DziTileSourceHelper.prototype = {
    ...
    createFromXmlString: function (xmlString, callback) {
    	
      var xmlString = '<?xml version="1.0" encoding="UTF-8"?><Image xmlns="http://schemas.microsoft.com/deepzoom/2008" Format="jpg" Overlap="1" TileSize="256"><Size Width="3894" Height="6143"/></Image>'
