...
/**
 * Class: OpenLayers.Handler.DLTSMouseWheel
 * Handler for wheel up/down events. Almost identical to MouseWheel. The difference reside
 * in the logic behind when to stop a wheel event.
 *
 * Inherits from:
 *  - <OpenLayers.Handler>
 */
OpenLayers.Handler.DLTSMouseWheel = OpenLayers.Class(OpenLayers.Handler, {
    /**
    ...
    CLASS_NAME: 'OpenLayers.Handler.DLTSMouseWheel'
});
